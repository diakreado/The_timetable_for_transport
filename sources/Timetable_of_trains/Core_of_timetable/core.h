...
private:
    ...
    /// Я с другими местами не сталкивался, но я исправлю
    ...
    /// С первого раза не понял, но я подумаю об этом
    ...
    /// Это я исправлю (надеюсь)

    /// Эти методы были в developer, они ещё сырые
